...
class NewsState extends GetxController {
  ...
  Future<void> fetchNewsVideo(int maxResult) async {
    try {
      ...
      String apiUrl =
          "https://www.googleapis.com/youtube/v3/videos?part=snippet,contentDetails,statistics&chart=mostPopular&regionCode=bd&videoCategoryId=25&maxResults=$maxResult&key=$apiKey";
